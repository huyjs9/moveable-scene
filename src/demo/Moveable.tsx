  ...
  return (
    <p className="badges" data-scena-element-id={props.scenaElementId}>
      ...
      <a href="https://github.com/daybrush/moveable" target="_blank">
        <img src="https://img.shields.io/github/stars/daybrush/moveable.svg?color=42b883&amp;style=flat-square" />
      </a>
      <a href="https://github.com/daybrush/moveable" target="_blank">
        <img src="https://img.shields.io/badge/language-typescript-blue.svg?style=flat-square" />
      </a>
      <br />
      <a href="https://github.com/daybrush/moveable/tree/master/packages/react-moveable" target="_blank">
        <img
          alt="React"
          src="https://img.shields.io/static/v1.svg?label=&amp;message=React&amp;style=flat-square&amp;color=61daeb"
        />
      </a>
      <a href="https://github.com/daybrush/moveable/tree/master/packages/preact-moveable" target="_blank">
        <img
          alt="Preact"
      ...
      <a href="https://github.com/daybrush/moveable/tree/master/packages/svelte-moveable" target="_blank">
        <img
          alt="Svelte"
...
class App extends React.Component {
  ...
  public render() {
    return (
      <div className="app">
        <Editor ref={this.editor} debug={true} />
        <div className="bottom">
          <a href="https://github.com/daybrush/moveable" target="_blank">
            Download
          </a>
          <a href="https://daybrush.com/moveable/release/latest/doc" target="_blank">
            API
          </a>
          <a href="https://daybrush.com/moveable/storybook" target="_blank">
            Storybook
          </a>
        </div>
      </div>
    ...
    this.editor
      .current!.appendJSXs(
        [
          {
            jsx: (
              <div className="moveable" contentEditable="true" suppressContentEditableWarning={true}>
                Moveable
              </div>
            ),
            name: '(Logo)',
          ...
          {
            jsx: (
              <div className="moveable">Moveable is Draggable! Resizable! Scalable! Rotatable! Warpable! Pinchable</div>
            ),
            name: '(Description)',
            frame: {
              position: 'absolute',
