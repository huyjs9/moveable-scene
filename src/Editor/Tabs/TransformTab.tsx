...
export default class TransformTab extends Tab {
  ...
  public renderTab() {
    return (
      <div className={prefix('transform-tab')}>
        <div className={prefix('tab-line')}>
          <TabInputBox ref={this.oInput} type={'half'} label="Anchor" input={Anchor} onChange={this.onChangeOrigin} />
          <TabInputBox
            ref={this.rInput}
            type={'half'}
            label="Rotation"
  ...
  public onRender = () => {
    ...
    this.oInput.current!.setValue([(origin[0] / rect.offsetWidth) * 100, (origin[1] / rect.offsetHeight) * 100])
  }
}
