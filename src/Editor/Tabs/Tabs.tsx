...
const TABS: Array<typeof Tab> = [CurrentTab, AlignTab, FontTab, LayerTab, TransformTab, FrameTab]
export default class Tabs extends React.PureComponent<{
  ...
  public render() {
    return (
      <div className={prefix('tabs')} ref={this.tabs} onMouseOver={this.onMouseOver} onMouseOut={this.blur}>
        {this.renderTabs()}
      </div>
    )
  }
  public renderTabs() {
    ...
    return TABS.map((UserTab) => {
      ...
      return (
        <div key={id} className={prefix('tab-icon', isSelected ? 'selected' : '')}>
          <div data-target-id={id} className={prefix('tab-icon-label')} onClick={this.onClick}>
