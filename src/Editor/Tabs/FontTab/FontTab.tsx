...
export default class FontTab extends Tab {
  ...
  public title = 'Font'
  public renderTab() {
    const [family, size, align, style, weight, decoration] = this.moveableData.getProperties(
      [['font-family'], ['font-size'], ['text-align'], ['font-style'], ['font-weight'], ['text-decoration']],
